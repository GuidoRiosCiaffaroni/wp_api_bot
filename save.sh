...
echo "git remote add origin https://github.com/GuidoRiosCiaffaroni/wp_api_bot.git"
git remote add origin https://github.com/GuidoRiosCiaffaroni/wp_api_bot.git
